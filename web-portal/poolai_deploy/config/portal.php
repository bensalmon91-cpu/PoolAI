 ...
 * Domain: poolai.modprojects.co.uk
 */

// Session settings
define('PORTAL_SESSION_NAME', 'poolai_session');
...
// Email settings
define('PORTAL_EMAIL_FROM', 'noreply@poolai.modprojects.co.uk');
define('PORTAL_EMAIL_FROM_NAME', 'PoolAI');

// URLs - root level, no /portal prefix
define('PORTAL_BASE_URL', 'https://poolai.modprojects.co.uk');
define('PORTAL_API_URL', 'https://poolaissistant.modprojects.co.uk/api/portal');

// CSRF token name
define('PORTAL_CSRF_TOKEN_NAME', 'poolai_csrf_token');
