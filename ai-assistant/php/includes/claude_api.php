...
class ClaudeAPI {
     ...
     *
     * @param string $system_prompt System instructions for Claude
     * @param string $user_message The user/context message
     * @param array $options Additional options (temperature, max_tokens, etc.)
     * @return array Response with 'success', 'content', 'tokens_used', etc.
     */
     ...
     * @param array $profile Current pool profile
...
PROMPT;
     ...
     * @param array $alarms Recent alarms
     * @param array $profile Pool profile
     * @param array $previous_suggestions Previous suggestions (to avoid repetition)
...
PROMPT;
     ...
     * @param int $device_id Device ID
     * @param string $pool Pool identifier
     * @param array $pool_stats Pool statistics
     * @param array $norms Cross-pool norms for comparison
